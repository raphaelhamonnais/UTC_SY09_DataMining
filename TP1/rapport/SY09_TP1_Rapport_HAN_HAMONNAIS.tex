...
La première chose importante à remarquer est la différence d'effectif entre les types d'individus~: nn a deux fois plus d'individus non diabétiques (355) que de diabétiques (177). Le choix des représentations graphiques et tests statistiques est important. Travailler sur le nombre avec par exemple des diagrammes en bâton donnera des résultat complètement faux. Des boîtes à moustache par contre seront plus à même de pointer des disparités entre les deux types d'individus.
