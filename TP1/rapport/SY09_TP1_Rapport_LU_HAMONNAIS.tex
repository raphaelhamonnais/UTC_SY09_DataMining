...
\begin{itemize}
	\item \textbf{valeurs propres}~: correspond à l'attribut \texttt{\$sdev} au carré (les écarts types de chaque composante au carré donnent la variance de chaque composante).
